...
def lookup_icon(name):
    return {
        'neverblock_client': LOGO_DEFAULT_PATH,
        'neverblock_client_connected': CONNECTED_LOGO_DEFAULT_PATH,
        'neverblock_client_disconnected': DISCONNECTED_LOGO_DEFAULT_PATH,
    }[name]
