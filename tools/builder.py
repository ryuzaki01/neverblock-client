...
INIT_PATH = 'neverblock_client/__init__.py'
SETUP_PATH = 'setup.py'
CHANGES_PATH = 'CHANGES'
BUILD_KEYS_PATH = 'tools/build_keys.json'
STABLE_PACUR_PATH = '../neverblock-pacur'
TEST_PACUR_PATH = '../neverblock-pacur-test'
BUILD_TARGETS = ('neverblock-client', 'neverblock-client-gtk')
...
if cmd == 'version':
    ...
    while True:
        ...
        for release in response.json():
            ...
            resp = requests.post(
                'https://git.neverblock.com/api/v3/projects' + \
    ...
    if not is_snapshot and version != new_version:
        print 'New version does not exist in changes' + version + ' -- ' + new_version
        sys.exit(1)
